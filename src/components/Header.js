    ...
    return (
      ...
      <div className="nav-header bg-white shadow-xs border-0">
        <div className="nav-top">
          <Link to="/">
            <img src="assets/images/Dazlogoheader.png" alt="logo" />
          </Link>
          <Link
            to="/defaultmessage"
              ...
              <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                ...
                <ul className="mb-1 top-content">
                  ...
                  <li>
                    ...
                    >
                      <i className="feather-layers btn-round-md bg-gold-gradiant me-3"></i>
                      <span>Alertas</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/shop2" className="nav-content-bttn open-font">
                      <i className="feather-package btn-round-md bg-mini-gradiant me-3"></i>
                      <span>Paquetes</span>
                    </Link>
                  </li>
                  <li>
                ...
                <ul className="mb-1">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span>Chat</span>
                      <span className="circle-count bg-warning mt-0">1</span>
                    </Link>
                  </li>
                </ul>
              </div>
